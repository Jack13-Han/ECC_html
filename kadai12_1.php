...
<body>
  ...
  <p>お名前：<?= $postData["uname"] ?></p>
  <p>フリガナ：<?= $postData["ruby"] ?></p>
  <p>メールアドレス：<?= $postData["mail"] ?></p>
  <p>パスワード：<?= $postData["password"] ?></p>
  <p>電話番号：<?= $postData["tel"] ?></p>
  <p>郵便番号：<?= $postData["postal"] ?></p>
  <p>住所：<?= $postData["address"] ?></p>
  <p>お得なクーポン：<?= $postData["checkDM"] ?></p>
</body>
</html>